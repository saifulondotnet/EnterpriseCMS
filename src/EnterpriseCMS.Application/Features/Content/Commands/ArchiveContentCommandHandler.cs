...
public class ArchiveContentCommandHandler : IRequestHandler<ArchiveContentCommand, ContentDto>
{
    private readonly IUnitOfWork _uow;
    private readonly ICurrentUserService _currentUser;

    public ArchiveContentCommandHandler(IUnitOfWork uow, ICurrentUserService currentUser)
    {
        _uow = uow;
        _currentUser = currentUser;
    }

    public async Task<ContentDto> Handle(ArchiveContentCommand request, CancellationToken ct)
    {
